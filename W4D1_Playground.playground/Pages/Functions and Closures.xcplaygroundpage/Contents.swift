 ...
 */
sayHello()
let x: String = sayHello(toPerson: "Jun")
let _: Void = sayHello(toPerson: "Jun")
/*:
 - Experiment:
 ...
 */
sayHelloClosure()
sayHelloClosureToPerson("Jun")
sayHelloClosureWithReturn("Jun")
/*:
 - Experiment:
 ...
 */
var ownClosure = { (number: Int, name: String) -> () in
  print("\(name) + \(number)")
}
ownClosure(2, "Hi")
/*:
 ...
 */
var explicit = { (input: String) -> (String) in
  return input
}
explicit("Hi")
/*:
 ...
 */
//: [Next](@next)
var ownCL = { (number: Int, name: String) -> String in
  return "\(name) + \(number)"
}
func sample(_ function: (Int, String) -> String, _ param: Int) -> String {
  return function(param, "Hi")
}
sample(ownCL, 5)
